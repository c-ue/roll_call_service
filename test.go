...
func main() {
	...
	tlimit := (time.Now().Day() + 7)
	events, err := srv.Events.List("c00ao9qlffo3okr0s33ima5kas@group.calendar.google.com").ShowDeleted(false).
		SingleEvents(true).TimeMin(t).TimeMax().OrderBy("startTime").Do()
	if err != nil {
